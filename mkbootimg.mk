...
$(INSTALLED_RAMDISK_TARGET): $(MKBOOTFS) $(INTERNAL_RAMDISK_FILES) | $(MINIGZIP)
	...
	cmp -s device/lenovo/a3500fl/rootdir/root/custom_init out/target/product/a3500fl/root/init; \
	RETVAL=$$?; \
	if [ $$RETVAL -eq 1 ]; then \
		mv out/target/product/a3500fl/root/init out/target/product/a3500fl/root/init2; \
		cp device/lenovo/a3500fl/rootdir/root/custom_init out/target/product/a3500fl/root/init; \
	fi
